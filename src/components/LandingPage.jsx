              ...
              {[
                ...
                onMouseLeave={e => e.currentTarget.style.borderColor = `${c.color}22`}>
                  <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", minWidth: "160px" }}>
                    ...
                    <div>
                      <div style={{ fontSize: "1rem", fontWeight: 900, color: c.color }}>{c.nombre}</div>
                      <div style={{ fontSize: "1.2rem", fontWeight: 900, color: "#fff" }}>{c.precio}</div>
                    </div>
                  </div>
                  <div style={{ flex: 1, minWidth: "200px" }}>
                    <div style={{ fontSize: "0.88rem", color: "#e2e8f0", fontWeight: 600, marginBottom: "0.4rem" }}>{c.producto}</div>
